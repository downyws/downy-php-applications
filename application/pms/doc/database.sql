...
-- ----------------------------
-- Table structure for `pms_channel`
-- ----------------------------
DROP TABLE IF EXISTS `pms_channel`;
...
-- ----------------------------
-- Table structure for `pms_send_list`
-- ----------------------------
DROP TABLE IF EXISTS `pms_send_list`;
CREATE TABLE `pms_send_list` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for `pms_short_uri`
-- ----------------------------
DROP TABLE IF EXISTS `pms_short_uri`;
CREATE TABLE `pms_short_uri` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for `pms_target`
-- ----------------------------
DROP TABLE IF EXISTS `pms_target`;
CREATE TABLE `pms_target` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for `pms_task_multi`
-- ----------------------------
DROP TABLE IF EXISTS `pms_task_multi`;
CREATE TABLE `pms_task_multi` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
...
-- ----------------------------
-- Table structure for `pms_task_single`
-- ----------------------------
DROP TABLE IF EXISTS `pms_task_single`;
CREATE TABLE `pms_task_single` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `target_id` int(10) unsigned NOT NULL,
  `title` varchar(100) NOT NULL,
  `content` text NOT NULL,
...
-- Records of `pms_user`
-- ----------------------------
INSERT INTO pms_user VALUES ('1', 'admin', '202cb962ac59075b964b07152d234b70', 'USER:READ;USER:EDIT;', null, '0', '0', '0');
