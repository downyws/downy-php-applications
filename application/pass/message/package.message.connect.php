...
define('CONNECT_LOGIN_DISABEL',			'030201010');
$GLOBALS['MESSAGE'][CONNECT_LOGIN_DISABEL] = '关联账号已被禁用。';
define('CONNECT_LOGIN_UNKNOWSTATUS',	'030201020');
$GLOBALS['MESSAGE'][CONNECT_LOGIN_UNKNOWSTATUS] = '关联账号状态错误，请联系管理员。';
define('CONNECT_LOGIN_NOTEXISTS',		'030201030');
$GLOBALS['MESSAGE'][CONNECT_LOGIN_NOTEXISTS] = '关联账号不存在。';
